...
export const metadata: Metadata = { title: "Company Interview Guides", description: "Company-specific engineering interview guide architecture and preparation paths." };
