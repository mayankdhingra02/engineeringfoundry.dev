...
export default async function CompanyPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <><AnalyticsEventOnMount event="company_page_viewed" properties={{ company_slug: company.slug, company_name: company.name }} />
    <PageHero eyebrow="Company preparation hub" title={`${company.name} engineering interview preparation`} description="A useful starting point for general preparation, reviewed contributor reports, and company-specific material with clear public or moderated community provenance."><StatusPill tone="accent">Curation in progress</StatusPill></PageHero>
