...
const faqs = [
  ...
  ["Do I need an account?", "No account is needed to browse public educational content or use the Mock Interview Practice Lab, Referral Toolkit, Engineering Challenge Lab, and Interview Experience Write-up Builder. Accounts may be needed for future saved progress, authenticated routing, reviewed submissions, profiles, and opt-in recognition."],
  ...
  ["Are interview experiences public?", "No. The current tool creates only a browser-memory draft and a copyable summary you control. No reviewed public experiences are published yet."],
  ["Can I post exact interview questions?", "Engineering Foundry encourages high-level process, topic, and reflection context—not proprietary question wording, confidential assessments, interviewer identities, or private material."],
  ["Is my interview-experience draft saved?", "No. It is not submitted, uploaded, or persisted. Refreshing or leaving the page clears it."],
