...
export const metadata: Metadata = { title: "DSA Interview Preparation", description: "Structured coding-interview roadmaps, topic filters, and demo practice questions." };
export default function DsaPage() { return <><PageHero eyebrow="Data Structures & Algorithms" title="Practice patterns. Build durable instincts." description="Follow a topic roadmap, focus by difficulty or company, and turn question practice into trackable progress."><a className="button" href="#questions">Browse questions <ArrowRight size={16} /></a></PageHero>
