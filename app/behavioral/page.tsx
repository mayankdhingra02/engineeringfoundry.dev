...
export const metadata = createPageMetadata({ title: "Behavioral Interviews", description: "Build strong stories and practice behavioral interviews.", path: "/behavioral" });
...
export default function Page() { return <LearningTrackPage config={config} roadmap="behavioral" />; }
