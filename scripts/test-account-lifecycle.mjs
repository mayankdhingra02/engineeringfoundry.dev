...
for (const section of ["applications", "interview_rounds", "interview_preparation", "behavioral", "dsa", "system_design", "preparation_activity", "calendar", "interview_playbook", "mock_interviews", "interview_experiences"]) {
...
assert.ok(exporter.includes('EXPORT_VERSION = "1.4"'), "export version was not bumped for P0.2 preparation activity");
