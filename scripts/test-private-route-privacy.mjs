...
for (const route of [
  ...
  "/dsa/questions/two-sum/practice/1b9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed",
  "/calendar",
  "/dashboard",
  "/settings/privacy",
  "/onboarding",
...
check(
  "robots disallow covers the DSA attempt editor",
  PRIVATE_ROBOTS_DISALLOW.includes("/dsa/questions/*/practice"),
);
