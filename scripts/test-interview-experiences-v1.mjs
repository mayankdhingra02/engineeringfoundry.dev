...
expect(page.includes("actor") && page.includes("getOwnedInterviewExperienceHistory(actor)") && page.includes('{ status: "anonymous" as const }'), "Private history must stay behind the account/actor boundary and use the strict production query helper.");
