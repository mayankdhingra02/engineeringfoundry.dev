...
expect(/export const dynamic = "force-dynamic";[\s\S]*export const dynamicParams = false;[\s\S]*generateStaticParams/.test(companyPage), "Company experience routes must render fresh moderated reports per request while retaining the closed company route catalog.");
...
expect(/export const dynamic = "force-dynamic";[\s\S]*export const dynamicParams = false;[\s\S]*generateStaticParams/.test(companyGuide), "Report-backed company guides must render fresh moderated reports per request while retaining the closed company route catalog.");
