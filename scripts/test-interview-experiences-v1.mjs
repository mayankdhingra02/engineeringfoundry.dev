...
expect(page.includes("No exact prompts or private identities") && companyPage.includes("interviewer identities") && companyPage.includes("explicitly choose to show their public Engineering Foundry username") && !companyPage.includes("No fabricated entries, counts, exact questions, or candidate identities are shown."), "Public privacy copy must distinguish protected identities from consented contributor username attribution.");
