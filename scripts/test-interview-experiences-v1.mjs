...
expect(page.includes("createSupabasePublicClient") && page.includes("const publicSupabase = createSupabasePublicClient()"), "Public directory needs a dedicated sessionless anon client.");
