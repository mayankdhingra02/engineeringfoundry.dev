...
const answerInput = read("lib/behavioral/answer-action-input.ts");
check("answer validation requires a source story", answerInput.includes("Choose the source story for this answer variant."));
