...
if (sdConceptsSeeded) {
  assertParity("System Design concepts", publishedConcepts.map((topic) => topic.id), sdConceptsSeeded);
  const publishedLeak = unpublishedConcepts.filter((topic) => sdConceptsSeeded.has(topic.id));
  check(
