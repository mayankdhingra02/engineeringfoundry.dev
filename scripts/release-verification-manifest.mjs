...
export const STATIC_STEPS = [
  ...
  ...[
    ...
    "test:homepage-entry", "test:global-search", "test:header-navigation", "test:practice-url-state", "test:resource-directory", "test:system-design-learning", "test:system-design-entry",
    ...
    "test:system-design-production-engineering", "test:system-design-architecture-patterns", "test:system-design-topic-crosswalk",
    ...
    "test:dsa-study-plans", "test:dsa-languages", "test:dsa-strategy", "test:dsa-practice-attempts", "test:dsa-required-closure",
