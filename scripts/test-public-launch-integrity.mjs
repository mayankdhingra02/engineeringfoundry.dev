...
requireText(header, "desktopTriggerRefs.current[openMenu]", "Desktop disclosure menus do not retain the invoking trigger for Escape focus restoration.");
requireText(header, "window.requestAnimationFrame(() => desktopTrigger?.focus())", "Desktop disclosure menus do not restore focus after Escape.");
requireText(header, "if (!desktopTrigger && !mobileOpen) return", "The global header Escape listener acts while every navigation disclosure is closed.");
requireText(header, "ref={triggerRef}", "Desktop disclosure trigger refs are not attached to their native buttons.");
...
requireText(globalStyles, "@media (min-width: 801px) and (max-width: 1180px)", "The 801–1180px navigation trigger has no dedicated visibility contract.");
requireText(globalStyles, ".mobile-nav { display: grid; position: absolute;", "The 801–1180px navigation trigger opens a visually hidden menu.");
