...
expect(migrations.length === 26 && latestMigration === "202608230003_restrict_public_interview_experience_columns.sql", "Production baseline must include the verified P0.1–P0.8 migration history and public Interview Experience column hardening.");
