...
4. `supabase db push`
5. `supabase migration list --linked`; confirm all **37** migrations are applied through `202609040003_save_interview_experience_if_revision.sql`.
