...
4. `supabase db push`
5. `supabase migration list --linked`; confirm all **35** migrations are applied through `202609040001_save_interview_reminder_preferences_if_revision.sql`.
