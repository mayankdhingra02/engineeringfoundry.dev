...
4. `supabase db push`
5. `supabase migration list --linked`; confirm all **36** migrations are applied through `202609040002_save_interview_playbook_diagnostic_inputs_if_revision.sql`.
