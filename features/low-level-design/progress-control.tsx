...
export function LowLevelDesignProgressControl({ itemId, label = "Mark this preparation activity complete" }: { itemId: string; label?: string }) {
  ...
  function toggle() {
    ...
    if (!complete) track("low_level_design_activity_recorded", { track: "low-level-design", item_id: itemId, status: "completed", persistence: "local" });
  }
