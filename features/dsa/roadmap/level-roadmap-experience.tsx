...
export function LevelRoadmapExperience({ accountProgress = {}, signedIn = false, preferredRoadmap = "sde2", accountPlatformAvailable }: { accountProgress?: DsaProgressMap; signedIn?: boolean; preferredRoadmap?: RoadmapLevel; accountPlatformAvailable: boolean }) {
