...
export function QuestionTable({ questions, companies, fixedCompanySlug, selectedCompanySlug, onToggleTopic, progress = {}, signedIn = false, applicationId }: { questions: DSAInterviewQuestion[]; companies: DSACompany[]; fixedCompanySlug?: string; selectedCompanySlug?: string; onToggleTopic: (topic: string) => void; progress?: DsaProgressMap; signedIn?: boolean; applicationId?: string }) {
