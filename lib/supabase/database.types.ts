  ...
  public: {
    Tables: {
      ...
      mock_interview_sessions: {
        Row: { id: string; user_id: string; track: "dsa" | "system-design" | "low-level-design" | "ml-design" | "behavioral"; practice_mode: "solo" | "peer"; plan_id: string; prompt_id: string; rubric_id: string; started_at: string; reviewed_at: string | null; elapsed_seconds: number | null; prompt_exposure: "fresh" | "repeated"; timing_mode: "suggested" | "extended" | "untimed"; hint_policy: "none" | "on-request" | "guided"; assistance_state: "unassisted" | "hint-used" | "redirection-used" | "hint-and-redirection"; session_outcome: "completed" | "interrupted" | "technical-failure"; session_issue: string | null; strength: string | null; improvement: string | null; follow_up_practice: string | null; created_at: string; updated_at: string };
        Insert: { id?: string; user_id: string; track: "dsa" | "system-design" | "low-level-design" | "ml-design" | "behavioral"; practice_mode: "solo" | "peer"; plan_id: string; prompt_id: string; rubric_id: string; started_at?: string; reviewed_at?: string | null; elapsed_seconds?: number | null; prompt_exposure?: "fresh" | "repeated"; timing_mode?: "suggested" | "extended" | "untimed"; hint_policy?: "none" | "on-request" | "guided"; assistance_state?: "unassisted" | "hint-used" | "redirection-used" | "hint-and-redirection"; session_outcome?: "completed" | "interrupted" | "technical-failure"; session_issue?: string | null; strength?: string | null; improvement?: string | null; follow_up_practice?: string | null; created_at?: string; updated_at?: string };
