...
import { INTERVIEW_PREPARATION_AREAS, type InterviewEvidenceItem, type InterviewPreparationArea } from "./evidence.ts";
 ...
 */
function buildNeutralDiagnostic(evidence: readonly InterviewEvidenceItem[] = []) {
